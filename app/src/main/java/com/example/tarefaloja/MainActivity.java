package com.example.tarefaloja;
...
public class MainActivity extends AppCompatActivity {
    ...
    /*Código produzido por: Mateus Henrique Onezorg Paiva - RA: 201811729;
    * Tarefa de conclusão de módulo, Palomakoba UNIR; */
    ...
    //Função para linkar os componente do .xml com o .java (apenas para fins estéticos).
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //chamando a função que faz a linkagem.
        Linkagem();
